...
#define __BTV_INIT              0       /* Initialize base address of trap vector table */
...
#define __START_INIT_TC1        0       /* Start TC1 */
#define __START_INIT_TC2        0       /* Start TC2 */
#define __START_INIT_TC3        0       /* Start TC3 */
#define __START_INIT_TC4        0       /* Start TC4 */
#define __START_INIT_TC5        0       /* Start TC5 */
