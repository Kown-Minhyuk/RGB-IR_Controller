...
#if defined(__TASKING__) && !defined(__NO_ILDD_TRAP_ALIASES__)
#pragma alias _trapassertion		IfxCpu_Trap_assertion
#pragma alias _trapbus			IfxCpu_Trap_busError
#pragma alias _trapcontext		IfxCpu_Trap_contextManagementError
#pragma alias _trapinstruction		IfxCpu_Trap_instructionError
#pragma alias _trapmmu			IfxCpu_Trap_memoryManagementError
#pragma alias _trapnmi			IfxCpu_Trap_nonMaskableInterrupt
#pragma alias _trapprotection		IfxCpu_Trap_internalProtectionError
#pragma alias _trapsystem		IfxCpu_Trap_systemCall_Cpu0
#endif
